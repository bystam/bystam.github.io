...
Not only that - I feel pretty confident that whatever diffs I produced would be something that I could in fact read and understand. Ruby is an imperative programming language like many others I have worked with - it has if-statements, loops, lambdas and classes. And Rails is somewhat similar to other web application frameworks, meaning I likely would be able to figure out what any generated web controller or ActiveRecord code does.
